...
public class BucketerParameterizedTest {
    ...
    public static Collection<Object[]> testCases() {
        ...
        expected = asList(new Bucket(dir + "-0", asList("file3", "file6"), 47),
                          new Bucket(dir + "-1", asList("file2", "file5"), 37),
                          new Bucket(dir + "-2", asList("file4", "file1"), 37));
        ...
        expected = asList(new Bucket(dir + "-0", asList("file6", "file5", "file4", "file3", "file2", "file1"), 21));
        ...
        expected = asList(
            new Bucket(dir + "-0", asList("file9", "file4"), 55),
            new Bucket(dir + "-1", asList("file1", "file8"), 55),
            new Bucket(dir + "-2", asList("file3", "file0", "file6"), 70),
            new Bucket(dir + "-3", asList("file5", "file11", "file10"), 60),
            new Bucket(dir + "-4", asList("file7", "file2"), 50));
        ...
        expected = asList(
            new Bucket(dir + "-0", asList("file0", "file4", "file3"), 100),
            new Bucket(dir + "-1", asList("file10", "file6", "file5"), 100),
            new Bucket(dir + "-2", asList("file12", "file8", "file7"), 100),
            new Bucket(dir + "-3", asList("file14", "file1", "file13", "file9"), 125),
            new Bucket(dir + "-4", asList("file2", "file11", "file15", "file16"), 115));
        ...
        expected = asList(
            new Bucket(dir + "-0", asList("file1", "file0"), 50),
            new Bucket(dir + "-1", asList("file3", "file2"), 50),
            new Bucket(dir + "-2", asList("file5", "file4"), 50),
            new Bucket(dir + "-3", asList("file7", "file6"), 50),
            new Bucket(dir + "-4", asList("file9", "file8"), 50));
        ...
        expected = asList(new Bucket(dir + "-1", asList("file2", "file1"), 55));
        ...
        expected = asList(
                new Bucket(dir + "-0", asList("file3"), 35),
                new Bucket(dir + "-1", asList("file2", "file1"), 55));
